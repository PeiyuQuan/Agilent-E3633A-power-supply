...
/* Generated from ../O.Common/DC.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devaaiStream,
    ...
    *pvar_dset_asynPfOctetWrite, *pvar_dset_devscalcoutStream,
...
static const char * const deviceSupportNames[] = {
    ...
    "devPrintfStdio", "asynPfOctetWrite", "devscalcoutStream",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devscalcoutStream, pvar_dset_devsCalcoutSoft,
...
int DC_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/uwchamber/epics/DC";
...
/* DC_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"DC_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(DC_registerRecordDeviceDriver(*iocshPpdbbase));
}
